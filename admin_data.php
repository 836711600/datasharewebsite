...
<table width="100%" border="1">
  ...
  <?php do { ?>
    <tr>
      ...
      <td align="center" valign="middle"><a href="admin_data_detail.php?id=<?php echo $row_Recordset1['dataid']; ?>">详情</a>|<a href="admin_changedata.php?id=<?php echo $row_Recordset1['dataid']; ?>">修改</a>|<a href="admin_deletedata.php?id=<?php echo $row_Recordset1['dataid']; ?>">删除</a></td>
    </tr>
