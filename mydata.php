...
$query_Recordset1 = sprintf("SELECT * FROM updata WHERE uper = %s ORDER BY creat_time DESC", GetSQLValueString($colname_Recordset1, "text"));
...
<table width="100%" border="1">
  ...
  <?php if($totalRows_Recordset1>0){do { ?>
    <tr>
      ...
      <td align="center" valign="middle"><a href="data_detail.php?id=<?php echo $row_Recordset1['dataid']; ?>">详情</a>|<a href="changedata.php?id=<?php echo $row_Recordset1['dataid']; ?>">修改</a>|<a href="deletedata.php?id=<?php echo $row_Recordset1['dataid']; ?>">删除</a></td>
    </tr>
