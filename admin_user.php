...
$query_Recordset1 = "SELECT * FROM user_reg";
...
<table width="100%" border="1">
  ...
  <?php do { ?>
    <tr>
      <td align="center"><?php echo $row_Recordset1['userid']; ?></td>
      <td align="center"><?php echo $row_Recordset1['username']; ?></td>
      <td align="center"><?php echo $row_Recordset1['email']; ?></td>
      <td align="center"><?php echo $row_Recordset1['usertel']; ?></td>
      <td align="center"><?php echo $row_Recordset1['regtime']; ?></td>
      <td align="center"><?php echo $row_Recordset1['class']; ?></td>
      <td align="center"><a href="admin_changeinfo.php?id=<?php echo $row_Recordset1['userid']; ?>">修改信息</a>|<a href="admin_deleteuser.php?id=<?php echo $row_Recordset1['userid']; ?>">删除</a></td>
    </tr>
