...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE user_reg SET password=%s, useradd=%s, email=%s, usertel=%s, words=%s, class=%s WHERE userid=%s",
...
<form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form1" id="form1">
  <table width="100%" border="1">
    ...
    <tr>
     ...
     <tr>
      ...
      <td><label for="class"></label>
       <input name="class" type="text" id="class" value="<?php echo $row_Recordset1['class']; ?>" /></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      &nbsp;&nbsp;&nbsp;<a href="admin_user.php" target="_self">取消修改</a></td>
    </tr>
  </table>
